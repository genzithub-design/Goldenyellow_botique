...
import { Navbar, Footer, TrueFocus, ScrollToTop, BackButton } from './components';
  ...
  return (
    <Router>
      ...
      <div className="min-h-screen bg-[var(--bg-primary)] font-sans text-[var(--text-main)] grain-bg relative overflow-x-hidden transition-colors duration-500">
        ...
        <div className="absolute top-[5vh] left-[-20vw] w-[60vw] h-[60vw] bg-gold-accent/4 rounded-full blur-[130px] pointer-events-none z-0" />
        <div className="absolute top-[80vh] right-[-20vw] w-[50vw] h-[50vw] bg-burgundy-900/3 rounded-full blur-[110px] pointer-events-none z-0" />
        ...
        <div className="absolute bottom-[5vh] right-[10vw] w-[40vw] h-[40vw] bg-burgundy-900/4 rounded-full blur-[100px] pointer-events-none z-0" />
